...
100 DD=37136:IFSY<>34THENPOKE56579,0:DD=56577
101 REM
102 REM
110 P$="a"
...
2325 IF(PEEK(DD)AND16)=0THENPRINT:PRINT"{reverse on}{red}LOST CONNECTION{reverse off}":GOTO2385
...
2380 PRINT:PRINT"{reverse on}{light green}Done.{reverse off}";CO$
2385 CLOSE3:CLOSE1
