...
11 POKE253,186:IFSY=246THENPOKE253,174:GRAPHIC1:GRAPHIC0
12 POKE254,PEEK(PEEK(253)):IFPEEK(254)<8THENPOKE254,8
13 IFSY=34THENX=23777:POKEX,170:IFPEEK(X)<>170THENPRINT"<16k":STOP
15 IFSY=246THENCLR:OPEN5,2,0,CHR$(24)+CHR$(5):COLOR0,2,7:COLOR4,15,6:GOTO17
16 OPEN5,2,0,CHR$(8):IFPEEK(65532)=34THENPOKE56,87:POKE54,87:POKE52,87
17 DIMPP$(25):P$="ok":POKE186,PEEK(PEEK(253)):BA=1200:XB=1200
...
71 IFSY=246THENTM=7936
80 I=TM:XM=51200:DD=56577:IFSY=34THENXM=0:DD=37136
81 IFSY=246THENDD=64874:XM=0
...
2451 IFSY=246THENCOLOR0,1,0:COLOR4,1,0
2453 SYSTM
2457 POKE53280,254:POKE53281,246:IFSY=34THENPOKE36879,27
2458 IFSY=246THENCOLOR0,2,7:COLOR4,15,6
...
41999 DATA -1
49999 STOP
50000 REMOPEN5,2,0,CHR$(8)
50001 CLR:OPEN5,2,0,CHR$(8+16)+CHR$(5):P$="":ML=4096:SYSML+12
50010 GET#5,A$:IFA$<>""THENPRINTA$;
50020 GETA$:IFA$<>""THENPRINT#5,A$;:IFA$="{pound}"THENPRINTPEEK(DEC("0314"))
50030 GOTO 50010
