!--------------------------------------------------
!- Thursday, June 22, 2017 5:06:06 PM
!- Import of : 
!- d:\dev\zimodem\cbm8bit\src\irc64-128.prg
!- Commodore 64
!--------------------------------------------------
1 REM IRC64/128  1200B 1.8+
2 REM UPDATED 06/21/2017 02:58P
...
110 P$="a"
120 PRINT"{clear}{down*2}IRC CHAT v1.2":PRINT"Requires 64Net WiFi firmware 1.8+"
