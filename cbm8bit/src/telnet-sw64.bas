!--------------------------------------------------
!- Tuesday, August 17, 2021 9:45:40 AM
!- Import of : 
!- z:\lost+found\telnet.prg
!- Commodore 64
!--------------------------------------------------
1 REM TELNET64SW  19200B 1.8+
...
102 REM
110 P$="a"
120 PRINTCO$;"{clear}{down*2}TELNET v1.5":PRINT"Requires Zimodem firmware 1.8+"
...
6020 PRINT#5,"+++";:PRINT".";
6030 GOSUB6100
6040 PRINT".";:PRINT#5,"ath":TT=TI+150
