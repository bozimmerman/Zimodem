!--------------------------------------------------
!- Thursday, June 22, 2017 5:05:56 PM
!- Import of : 
!- d:\dev\zimodem\cbm8bit\src\configure64-128.prg
!- Commodore 64
!--------------------------------------------------
...
40 IFSY=226ANDPEEK(ML)<>76THENCLOSE5:LOAD"pml64.bin",PEEK(254),1:RUN
...
100 REM
110 P$="a"
120 PRINT"{clear}{down*2}CONFIGURE v1.2":PRINT"Requires 64Net WiFi Firmware 1.5+"
...
205 PRINT#5,CHR$(17);CR$;"athz0f3e0";CR$;
