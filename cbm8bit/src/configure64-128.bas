!--------------------------------------------------
!- Monday, May 22, 2017 2:09:46 AM
!- Import of : 
!- c:\src\zimodem\cbm8bit\src\configure64-128.prg
!- Commodore 64
!--------------------------------------------------
1 REM CONFIGURE64/128  1200B 1.8+
2 REM UPDATED 05/20/2017 07:54P
10 IFPEEK(65532)=61THENPOKE58,254:CLR
15 OPEN5,2,0,CHR$(8):DIMWF$(100):WF=0:P$="ok":DIMPB$(50)
