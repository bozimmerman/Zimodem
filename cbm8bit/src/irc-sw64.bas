...
12 GOSUB9200:IFSY=61THENPOKE58,254:CLR
...
20 CR$=CHR$(13):PRINTCHR$(14);:GOSUB9200:POKE53280,254:POKE53281,246
...
44 IFSY=227ANDPEEK(51201)<>3THENCLOSE5:LOAD"swiftdrvr.bin",PEEK(254),1:RUN
...
9200 SY=PEEK(65532):BC=8
9210 IFSY<>226THEN9240
9220 X=PEEK(56834):POKE56834,X+1:IFPEEK(56834)<>X+1THEN9240
9230 BC=15:SY=227:POKE56834,X:RETURN
9240 PRINTCHR$(14);"Requires a C64 with SwiftLink/Link232":STOP
