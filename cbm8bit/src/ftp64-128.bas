!--------------------------------------------------
!- Sunday, May 14, 2017 10:00:55 PM
!- Import of : 
!- c:\src\zimodem\cbm8bit\ftp64-128.prg
!- Commodore 64
!--------------------------------------------------
1 REM FTP64/128  1200B 2.0+
2 REM UPDATED 04/09/2017 02:39P
...
230 PRINT#5,"ate0v1x1f3q0s40=128s0=1s41=0";CR$;CHR$(19);:REM A50764
...
1210 PRINT#5,"ati3":TT=TI+100
1215 IFTI<TTTHENGET#5,A$:GOTO1215
...
1290 UN$="":PA$="":GOTO1230
1300 P$="PASV":GOSUB600:GOSUB850:IFP$=""THEN1300
...
1400 PRINT#5,"at";CC$;QU$;H0$;QU$:GOSUB900
1410 IFLEN(P$)>8ANDLEFT$(P$,8)="connect "THENSP=VAL(MID$(P$,9)):GOTO 1420
1412 IFR0>1THEN1300
1415 R0=R0+1:PRINT"{pink}{reverse on}Retry to connect to ";H0$;"{reverse off}{light blue}":GOTO1400
...
2075 IFP$="?"THENP$="help"
2080 IFP$="help"THENPRINT"{light green}{reverse on}get put ls cd dir quit"
...
6190 FX=1
6200 IFP0=PANDY=1ANDP$<>""THENY$=P$:GOTO6100
6210 IFP0=PANDP$=""THEN6100
6215 IFP0=PANDLEFT$(P$,4)="550 "THENPRINTP$:GOTO6250
6220 IFP0=PANDLEFT$(P$,4)="226 "THENY=1:Y$=P$:GOTO6100
6225 IFP0=PANDLEFT$(P$,4)="150 "THENPRINTP$:PRINT:GOTO6100
6230 IFP0=SPANDLEN(P$)>0THENPRINT#8,P$;:TT=TT+LEN(P$):GOSUB6500:GOTO6100
6235 IFP0=PTHEN6100
6240 IFY=0THEN6100
...
7150 GOSUB800
7200 IFP0=PANDLEN(P$)>3ANDLEFT$(P$,3)="550"THENPRINTP$:GOTO7250
...
50030 GOTO 50010
55555 F$="ftp64-128":OPEN1,8,15,"s0:"+F$:CLOSE1:SAVE(F$),8:VERIFY(F$),8
