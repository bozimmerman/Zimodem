...
2 REM UPDATED 07/15/2017 12:54A
...
56 POKE981,0:LOAD"x-xfer128.bin",8,1:POKE981,15:RUN
60 IFPEEK(ML+1)<>217THENCLOSE5:LOAD"pml128.bin",PEEK(254),1:RUN
61 IFS8=128THENXB=2400
...
102 REM
110 P$="a"
120 PRINT"{clear}{down*2}C= BBS v1.4":PRINT"Requires C64Net WiFi firmware 1.8+"
...
2460 IF(PEEK(56577)AND16)=0THEN2500
2470 PRINT:PRINT"{light blue}{reverse off}U)pload, D)ownload, H)angup, or C)ont: ";
2480 GETA$:IFA$="u"ORA$="U"THEN2600
2485 IFA$="d"ORA$="D"THEN2700
2490 IFA$="c"ORA$="C"THEN2430
2495 IFA$<>"h"ANDA$<>"H"THEN2480
2496 PRINT"h"
2500 PRINT:PRINT"{reverse off}{light blue}Hanging up...";:GOSUB6000
