!--------------------------------------------------
!- Thursday, June 22, 2017 5:05:52 PM
!- Import of : 
!- d:\dev\zimodem\cbm8bit\src\cbmbbs64-128.prg
!- Commodore 64
!--------------------------------------------------
...
102 REM
110 P$="a"
120 PRINT"{clear}{down*2}C= BBS v1.2":PRINT"Requires 64Net WiFi firmware 1.8+"
...
2320 PRINT#5,CR$;"ath"+AT$+"f3c";QU$;HO$;":";MID$(STR$(PO),2);QU$;CR$;
