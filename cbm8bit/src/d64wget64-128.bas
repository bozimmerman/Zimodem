!--------------------------------------------------
!- Tuesday, June 20, 2017 3:33:05 AM
!- Import of : 
!- c:\src\zimodem\cbm8bit\src\d64wget64-128.prg
!- Commodore 64
!--------------------------------------------------
1 REM D64WGET4/128  1200B 1.8+
2 REM UPDATED 06/20/2017 02:46A
10 POKE254,PEEK(186):POKE253,PEEK(56579):IFPEEK(254)<8THENPOKE254,8
...
100 POKE56579,PEEK(253)
101 REM
102 REM
110 P$="a"
120 PRINT"{clear}{down*2}D64WGET v1.0":PRINT"Requires 64Net WiFi firmware 2.0+"
...
1210 PRINT"{reverse on}{light green}Sending request...{reverse off}{light blue}":PRINT#5,"at":GOSUB6000:GOSUB6000
...
50030 GOTO 50010
55555 F$="d64wget64-128":OPEN1,8,15,"s0:"+F$:CLOSE1:SAVE(F$),8:VERIFY(F$),8
