!--------------------------------------------------
!- Thursday, June 22, 2017 5:05:59 PM
!- Import of : 
!- d:\dev\zimodem\cbm8bit\src\d64wget64-128.prg
!- Commodore 64
!--------------------------------------------------
1 REM D64WGET4/128  1200B 1.8+
2 REM UPDATED 06/21/2017 02:46P
...
102 REM
110 P$="a"
120 PRINT"{clear}{down*2}D64WGET v1.2":PRINT"Requires 64Net WiFi firmware 2.0+"
...
1011 PRINT"written.{space*2}Are you sure (y/n)? ";:GOSUB5000
...
2305 PRINT"{space*15}{left*15}"+STR$(T)+","+STR$(S):PRINT"{up}";
