...
2 REM UPDATED 07/17/2017 02:46P
...
102 REM
110 P$="a"
120 PRINT"{clear}{down*2}D64WGET v1.3":PRINT"Requires C64Net WiFi firmware 2.0+"
...
50030 GOTO 50010
55555 U=8:F$="d64wget64-128":OPEN1,U,15,"s0:"+F$:CLOSE1:SAVE(F$),U:VERIFY(F$),U
