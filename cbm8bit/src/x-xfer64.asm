...
; C64 Specific locations
TIMEHB = $A0
TIMEMB = $A1
TIMELB = $A2
SHFLAG = $028D
RIDBS = $029B ; index to first char in input buffer
RIDBE = $029C ; index to last char in input buffer
RODBS = $029D ; index to first char in output buffer
RODBE = $029E ; index to last char in output buffer
KEYINDEX = $C6
CASSSYNCCT = $A5
STATUS = $90
